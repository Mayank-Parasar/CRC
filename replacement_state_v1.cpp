...
{
    // All above parameters are taken by default or by command line
...
void CRC_CACHE::InitCache()
{
    ...
    for(UINT32 setIndex=0; setIndex<numsets; setIndex++) 
    {
        ...
        for(UINT32 way=0; way<assoc; way++) 
        {
            ...
            cache[ setIndex ][ way ].sharing_dir = 0;  // the purpose of 'sharing_dir' is still not clear to me
        }
    }
